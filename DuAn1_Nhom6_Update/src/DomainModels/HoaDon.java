...
public class HoaDon {
    ...
    public HoaDon(String idHd, String idCtsp, int maHd, String maSp, String ngayTao, String ngayTT, String maKh, String tenKh, String tenNv, double donGia, double giamGia, double tongTien, double tienKhachDua, double tienThua, String hinhThucBh, String hinhThucTT, String tinhTrang, String ghiChu, int soLuong) {
        this.idHd = idHd;
        this.idCtsp = idCtsp;
        this.maHd = maHd;
        this.maSp = maSp;
